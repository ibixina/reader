...
void SearchPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SearchPanel::*)(const reader::DocumentAnchor & )>(_a, &SearchPanel::anchorActivated, 0))
            return;
    }
}
...
// SIGNAL 0
void SearchPanel::anchorActivated(const reader::DocumentAnchor & _t1)
{
