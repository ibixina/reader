...
void OutlinePanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->anchorActivated((*reinterpret_cast<std::add_pointer_t<reader::DocumentAnchor>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (OutlinePanel::*)(const reader::DocumentAnchor & )>(_a, &OutlinePanel::anchorActivated, 0))
            return;
    }
}
...
// SIGNAL 0
void OutlinePanel::anchorActivated(const reader::DocumentAnchor & _t1)
{
